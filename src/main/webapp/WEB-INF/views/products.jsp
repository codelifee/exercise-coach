...
<body>
	...
	<h1 class="text-center">
		Spring Boot Image Upload &amp; Display With Blob Using Database <a
			href="${pageContext.request.contextPath}/home"
			class="btn btn-danger text-right">Go Home</a>
	</h1>
	<br>
	<br>
	<table id="example"
		...
		<tbody>
			...
			<c:forEach var="product" items="${products}">
				...
				<tr>
					...
					<td><img
						src="${pageContext.request.contextPath}/products/display/${product.id}" /></td>
