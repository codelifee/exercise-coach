...
public interface ProductDetailsMapper {
	...
	@Insert("INSERT INTO product_details(product_id,product_color,product_stock, product_size) "
			+ "VALUES(#{productDetails.product_id},#{productDetails.product_color},#{productDetails.product_stock},#{productDetails.product_size})")
	...
	@Update("UPDATE product_details SET product_id=#{product_id},product_color=#{product_color},"
			+ "product_stock=#{product_stock}, product_size=#{product_size} WHERE product_detail_id=#{product_detail_id}")
